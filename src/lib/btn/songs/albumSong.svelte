...
<li>
    <div class="grid grid-cols-2 gap-x-4 items-center h-fit py-2 px-3 bg-light-purple/5 rounded-md shadow-md">
        <span class="text-xl justify-self-start w-52 text-left">{title}</span>
        <section class="grid grid-rows-1 grid-flow-col justify-evenly">
            <button class="hover:bg-light-purple/15 justify-self-end hover:scale-105 text-[#355070] rounded-full hover:shadow-md p-1 aniBase" on:click={() => isPlaying()}>
            ...
            <button class:liked="{liked}" class:norm="{!liked}" class="hover:bg-light-purple/15 justify-self-end hover:scale-105 text-mid-pink rounded-full hover:shadow-md p-1 aniBase" on:click={() => heart()}>
