...
<style>
    article{ @apply float-left border-t-[0.5px] border-light-purple/25 text-left pt-2 pl-2; }
    section{ @apply grid grid-rows-1 grid-flow-col gap-x-4 justify-start pt-4; }
</style>