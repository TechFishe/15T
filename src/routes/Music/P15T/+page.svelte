...
<Main>
    <header class="grid grid-rows-2 grid-cols-12 px-4 pt-2">
        ...
        <div class="text-left self-start row-span-1 row-start-2 col-start-3 col-span-full pl-2 space-y-1">
            ...
            <button class:liked="{liked}" class:norm="{!liked}" class="hover:bg-light-purple/10 hover:scale-105 text-mid-pink rounded-full p-1 transition-all duration-200 ease-in" on:click={() => liked = !liked}>
